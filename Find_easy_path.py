...
nexux_stats_URL='https://api.nexus-stats.com/warframe/v1/items?data=prices'     #This is the API key for getting nexus stat prices
...
nexus_stats_URL='http://api.nexus-stats.com/warframe/v1/items?data=prices'
